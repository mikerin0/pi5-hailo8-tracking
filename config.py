...
TABLE_PICK_MANUAL_CENTER_FRAMES_REQUIRED = 3
TABLE_PICK_MANUAL_CENTER_TOL_NORM = 0.10
TABLE_PICK_MANUAL_MIN_CONFIDENCE = 0.20
TABLE_PICK_MANUAL_MIN_HUNT_SEC = 1.8
TABLE_PICK_MANUAL_HUNT_ENABLED = True
TABLE_PICK_MANUAL_HUNT_AMPLITUDE_Y = 0.07
TABLE_PICK_MANUAL_HUNT_PERIOD_SEC = 3.0
